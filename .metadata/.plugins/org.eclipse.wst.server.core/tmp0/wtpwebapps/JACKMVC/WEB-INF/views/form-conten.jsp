			...
			<div class="row vh-100">
				...
				<div class="col-md-9 page border-top">
					...
					<div class="edit-form m-3 border">
						<h4 class="py-2 pl-3 border-bottom bg-light">Content form
							elements</h4>
						<form:form class="ml-3 mb-3" method="POST" modelAttribute="Content" action="${pageContext.request.contextPath}/home/form-conten">
							<div class="form-group">
								<label for="firstName">Title</label> <form:input type="text"
									class="form-control" id="firstName"
									placeholder="Enter first title" path = "title" />
							</div>
							<div class="form-group">
								<label for="exampleFormControlTextarea1">Brief</label>
								<form:textarea class="form-control" id="exampleFormControlTextarea1"
									rows="2" path = "brief"></form:textarea>
