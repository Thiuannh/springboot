...
public class UserController {
	...
	public RedirectView doLogin(@ModelAttribute("user") User user, RedirectAttributes redirectAttributes, Model model) {
		User userData =  employeeService.login(user);
		
		model.addAttribute("userSession", userData);
