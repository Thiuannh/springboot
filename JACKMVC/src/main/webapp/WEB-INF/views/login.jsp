		...
		<div class="row content">
			...
			<div class="col-md-6">
				<div class="form-login">
					...
					<form:form class="mx-3 my-3" method="POST"
						action="./login" modelAttribute="user">
						<div class="form-group">
							<form:input type="text" class="form-control" id="userName" placeholder="User name" path = "userName" />
							 <span class="text-danger error"></span>
						</div>
						<div class="form-group">
							<form:input type="password" class="form-control" id="password"
								placeholder="password" path = "password" /> <span
